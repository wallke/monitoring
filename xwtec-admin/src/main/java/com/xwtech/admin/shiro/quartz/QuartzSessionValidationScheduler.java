package com.xwtech.admin.shiro.quartz;
...
public class QuartzSessionValidationScheduler implements SessionValidationScheduler {
    ...
    private static final String SHIRO_SCHEDULER_NAME = "SHIRO_SCHEDULER";
    ...
    protected Scheduler getScheduler() throws SchedulerException {
        if (this.scheduler == null) {
            this.scheduler = new StdSchedulerFactory(quartzProperties()).getScheduler();//StdSchedulerFactory.getDefaultScheduler();
            ...
            SimpleTrigger trigger = TriggerBuilder
                    ...
                    .withSchedule(
                            SimpleScheduleBuilder
                                    .simpleSchedule()
                                    .withIntervalInMilliseconds(sessionValidationInterval) //触发时间
                                    .repeatForever()  //重复执行
                    )
                    .build();
    ...
    private Properties quartzProperties() {
        ...
        quartzProperties.setProperty("org.quartz.scheduler.instanceName", SHIRO_SCHEDULER_NAME);
        ...
        quartzProperties.setProperty("org.quartz.threadPool.threadPriority", "1");
