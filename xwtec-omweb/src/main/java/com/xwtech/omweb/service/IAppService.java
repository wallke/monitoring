...
public interface IAppService {
     ...
     * @return
     */
    List<App> queryAppList(@Param("appNum")String appNum, @Param("appName")String appName, @Param("categoryId")String categoryId, @Param("cropId")String cropId, PageInfo pageInfo);
     ...
     * @return
     */
    List<App> queryAllContactList(@Param("contactId")String contactId,PageInfo pageInfo);
     ...
     * @return
     */
    List<App> queryAppListByGroupId(@Param("groupId")String groupId,PageInfo pageInfo);
